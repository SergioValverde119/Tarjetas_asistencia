...
// Auto-llenado de Username (Login) con RFC
watch(() => form.rfc, (val) => {
    if (val) {
    ...
    try {
        ...
        if (data.status === 'success') {
            ...
            if (data.match_type === 'code') {
                ...
                // Opcional: Podrías separar el nombre de BioTime para llenar los campos
                // pero es mejor respetar lo que el usuario escribió manualmente.
...
const submit = () => {
    form.transform((data) => ({
        ...
        onError: (errors) => {
            ...
            resultMessage.value = `Por favor revisa el formulario, hay ${count} errores.`;
            showResultModal.value = true;
        }
    });
};
                            ...
                            <div class="mb-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input v-model="form.username" type="text" class="w-full rounded-lg border-gray-300 focus:border-blue-500 shadow-sm uppercase bg-gray-50" placeholder="Autogenerado del RFC" maxlength="13">
                            ...
                            <div class="mb-8 bg-blue-50 -mx-8 px-8 py-6 border-t border-b border-blue-100">
                                ...
                                <div class="flex flex-col md:flex-row gap-4 items-end">
                                    ...
                                    <div class="w-full md:w-1/2 min-h-[42px] flex items-center">
                                        ...
                                        <div v-else class="text-xs text-gray-400 italic">Ingresa el código y comprueba conexión.</div>
                                    </div>
                                </div>
